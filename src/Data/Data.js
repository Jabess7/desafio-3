export const blog = [
    {   
        id:1,
        title: "Transforme Ideias em Experiências Visuais Impactantes!",
        date: "10 out 2023",
        resourcesEmployed: "Design, Figma",
        description: "O projeto DeliverEase surge como uma resposta inovadora e centrada no usuário para melhorar a experiência de delivery de alimentos, oferecendo uma plataforma intuitiva e atraente, desenvolvida no Figma."

    },
    {
        id:2,
        title: "Calculadora de IMC em React",
        date: "21 Feb 2024",
        resourcesEmployed: "React, JavaScrip,",
        description: "Transformando Conhecimento em Prática. Este projeto representa um passo significativo na minha jornada de aprendizado em desenvolvimento web, onde me desafiei a criar uma Calculadora de Índice de Massa Corporal (IMC) utilizando a biblioteca React. A iniciativa faz parte do curso da Udemy, e o foco foi aplicar os conceitos teóricos aprendidos em um projeto prático e funcional."
